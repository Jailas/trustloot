...
public class TrustlootApp {

    private static final Logger log = LoggerFactory.getLogger(TrustlootApp.class);

    private final Environment env;

    public TrustlootApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes trustloot.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(TrustlootApp.class);
